...
build_time_vars = {'AC_APPLE_UNIVERSAL_BUILD': 0,
 ...
 'BLDSHARED': 'aarch64-oe-linux-gcc   -shared -Wl,-O1 -Wl,--hash-style=gnu -Wl,--as-needed',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'CONFIG_ARGS': "'--build=x86_64-linux' '--host=aarch64-oe-linux' '--target=aarch64-oe-linux' '--prefix=/usr' '--exec_prefix=/usr' '--bindir=/usr/bin' '--sbindir=/usr/sbin' '--libexecdir=/usr/libexec' '--datadir=/usr/share' '--sysconfdir=/etc' '--sharedstatedir=/com' '--localstatedir=/var' '--libdir=/usr/lib' '--includedir=/usr/include' '--oldincludedir=/usr/include' '--infodir=/usr/share/info' '--mandir=/usr/share/man' '--disable-silent-rules' '--disable-dependency-tracking' '' '--with-system-ffi' '--with-threads' '--with-pymalloc' '--without-cxx-main' '--with-signal-module' '--enable-shared' '--enable-ipv6=yes' 'ac_cv_header_bluetooth_bluetooth_h=no' 'ac_cv_header_bluetooth_h=no' 'ac_cv_file__dev_ptmx=yes' 'ac_cv_file__dev_ptc=no' 'ac_cv_working_tzset=yes' '--enable-ipv6' 'build_alias=x86_64-linux' 'host_alias=aarch64-oe-linux' 'target_alias=aarch64-oe-linux' 'CC=aarch64-oe-linux-gcc  ' 'CFLAGS= -O2 -pipe -g -feliminate-unused-debug-types ' 'LDFLAGS=-Wl,-O1 -Wl,--hash-style=gnu -Wl,--as-needed' 'CPPFLAGS=' 'CPP=aarch64-oe-linux-gcc -E  ' 'PKG_CONFIG_PATH=/usr/lib/pkgconfig:/usr/share/pkgconfig' 'PKG_CONFIG_LIBDIR=/usr/lib/pkgconfig'",
 'CONFINCLUDEDIR': '/usr/include',
 'CONFINCLUDEPY': '/usr/include/python2.7',
 'COREPYTHONPATH': ':plat-linux2:lib-tk:lib-old',
 'COVERAGE_INFO': '/python/2.7.16-r1/build/coverage.info',
 'COVERAGE_REPORT': '/python/2.7.16-r1/build/lcov-report',
 ...
 'LDCXXSHARED': 'aarch64-oe-linux-g++   -shared',
 'LDFLAGS': '-Wl,-O1 -Wl,--hash-style=gnu -Wl,--as-needed',
 'LDLAST': '',
 'LDLIBRARY': 'libpython2.7.so',
 'LDLIBRARYDIR': '',
 'LDSHARED': 'aarch64-oe-linux-gcc   -shared -Wl,-O1 -Wl,--hash-style=gnu -Wl,--as-needed',
 'LIB': 'lib',
 'LIBC': '',
 ...
 'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/python/2.7.16-r1/build _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=/usr/lib/python2.7/lib-dynload/:$(shell test -f pybuilddir.txt && echo /python/2.7.16-r1/build/`cat pybuilddir.txt`:)../Python-2.7.16/Lib:../Python-2.7.16/Lib/plat-linux2 python2.7',
 ...
 'abs_builddir': '/python/2.7.16-r1/build',
 'abs_srcdir': '/python/2.7.16-r1/build/../Python-2.7.16',
 'build': 'x86_64-pc-linux-gnu',
 'datarootdir': '/usr/share',
 'exec_prefix': '/usr',
 'host': 'aarch64-oe-linux-gnu',
 'prefix': '/usr',
